...
class MainWindow(CTk):
    def __init__(self):
        ...
        button1 = CTkButton(BottomContainer, width=175, height=58, border_width=2, fg_color="#00b6e3", hover_color="#3b8ed0", border_color="#00b6e3", text="Open Window 1", command=self.open_window1)
        button1.grid(row=0, column=0, sticky="nsew", padx=10, pady=10)

        # BUTTON 2 - Bottom Container
        button2 = CTkButton(BottomContainer, width=175, height=58, border_width=2, fg_color="#00b6e3", hover_color="#3b8ed0", border_color="#00b6e3",text="Open Window 2", command=self.open_window2)
        button2.grid(row=0, column=1, sticky="nsew", padx=10, pady=10)

        # BUTTON 2 - Footer Container
        button2 = CTkButton(FooterContainer, width=175, height=58, border_width=2, fg_color="#00b6e3", hover_color="#3b8ed0", border_color="#00b6e3",text="Open Window 2", command=self.open_window2)
        button2.grid(row=0, column=1, sticky="nsew", padx=10, pady=10)
